    ...
    <div>
      ...
      <main className="mx-auto flex min-h-screen max-w-2xl items-center px-4 pb-10 pt-24">
        <section className="w-full rounded-xl border border-amber-200 bg-amber-50 p-6 shadow-sm">
          <h1 className="text-2xl font-bold text-amber-900">Reset Password Unavailable</h1>
          <p className="mt-3 text-sm text-amber-800">
            This backend currently does not provide <code>/api/auth/reset-password/:token</code>.
            No reset request is sent from this page.
          </p>
